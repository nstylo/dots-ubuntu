# Generated by Powerlevel10k configuration wizard on 2020-04-03 at 11:16 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=1
  ...
  # if not empty, incorrect name shown when virtualenv is called e.g. 'venv'
  ...
  # Show go 6ersion only when in a go project subdirectory.
